    ...
    public static function form(Form $form): Form
    {
        return $form->schema([
            ...
            Forms\Components\Section::make('Breed Purity & Pedigree Registration')
                ...
                ->schema([
                    /*
                     * Purity target always follows Animal Identity → Breed.
                     * It is stored hidden so users do not choose the same breed twice.
                     */
                    ...
                    Forms\Components\Placeholder::make('purity_breed_display')
                        ...
                        ->content(function (Forms\Get $get): HtmlString {
                            ...
                            return new HtmlString(
                                '<div style="border:1px solid #bbf7d0;border-left:5px solid #15803d;background:#f0fdf4;padding:12px 14px;border-radius:8px;color:#14532d;font-size:14px;font-weight:900;">'
                                . e($breed?->breed_name ?? 'Select a breed under Animal Identity')
            ...
            Forms\Components\Section::make('Lineage & Location')
                ...
                ->schema([
                    ...
                    Forms\Components\Select::make('current_location_id')
                        ...
                        ->required()
                        ->helperText(
                            'Select the animal station. You may add a new location without leaving this form.'
                        )
                        ->hintAction(
                        ...
                        ->createOptionAction(
                            fn (FormAction $action): FormAction => $action
                                ...
                                ->extraModalWindowAttributes([
                                    'class' => 'lelekwe-location-quick-create',
                                ])
                                ->modalHeading('Add Animal Location')
                                ->modalDescription(
                                    'Create a station without leaving the animal form.'
                                )
        ...
        $table = $table
            ...
            ->actions([
                ...
                Tables\Actions\Action::make('generateAnimalProfilePdf')
                    ...
                    ->iconButton()
                    ->tooltip('Generate animal pedigree profile & history')
                    ->color('danger')
                    ->visible(
                        fn (): bool => auth()->user()?->can('view animals') ?? false
                    )
