                    ...
                    <div class="hr-command-wrap">
                        ...
                        <div class="hr-command-grid">
                            @foreach ($hrCards as $card)
                                <div class="hr-command-card {{ $card['value'] === 0 ? 'hr-command-card-muted' : '' }}"
                                    style="--hr-color: {{ $card['color'] }};">
                                    <div class="hr-command-top">
                                        <div class="min-w-0">
                                            <div class="hr-command-title">{{ $card['title'] }}</div>
                                            <div class="hr-command-subtitle">{{ $card['subtitle'] }}</div>
                                        </div>
                                    ...
                                    <div class="hr-command-bottom">
                                        <div class="hr-command-value">{{ number_format($card['value']) }}</div>
                                        <div class="hr-command-pill">{{ $card['pill'] }}</div>
                                    </div>
                                </div>
                            @endforeach
                        </div>
                    ...
                    <div class="hr-payroll-wrap">
                        <div class="hr-block-head">
                            ...
                            <div class="hr-block-badge">
                                ...
                                {{ now('Africa/Nairobi')->format('M Y') }}
                            </div>
                        </div>

                        <div class="hr-payroll-grid">
                            @foreach ($payrollCards as $card)
                                <div class="hr-payroll-card {{ $card['value'] === 'KES 0.00' || $card['value'] === '0' ? 'hr-payroll-card-muted' : '' }}"
                                    style="--hr-color: {{ $card['color'] }};">
                                    <div class="hr-payroll-top">
                                        <div class="min-w-0">
                                            <div class="hr-payroll-title">{{ $card['title'] }}</div>
                                            <div class="hr-payroll-subtitle">{{ $card['subtitle'] }}</div>
                                        </div>
                                    ...
                                    <div class="hr-payroll-bottom">
                                        <div class="hr-payroll-value {{ $card['is_money'] ? 'hr-payroll-money' : '' }}">
                                            {{ $card['value'] }}
                                        </div>
