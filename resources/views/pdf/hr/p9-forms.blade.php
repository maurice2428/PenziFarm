@php
    ...
    $employerPin = setting('company.kra_pin', 'P12121212V');
            ...
            @foreach ($months as $mNum => $mName)
                @php
                    ...
                    if ($row) {
                        ...
                        // Match your old reference logic more closely:
                        ...
                        $personalRel = 2400.00; // standard monthly relief per your reference
                        $insuranceRel = 0.0;
