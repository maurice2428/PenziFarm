        ...
        <table class="kpi-table">
            <tr>
                ...
                <td class="kpi-card">
                    ...
                    <div class="kpi-value">{{ number_format($activeLocations) }}</div>
                </td>

                <td class="kpi-card">
                    <div class="kpi-label">Default</div>
                    <div class="kpi-value">{{ number_format($defaultLocations) }}</div>
                </td>
        ...
        <table class="items">
            ...
            <tbody>
                @forelse ($locations as $index => $location)
                    <tr>
                        <td>{{ $index + 1 }}</td>
                        <td><strong>{{ $location->name }}</strong><br><span class="small-muted">{{ $location->address ?: 'No address recorded' }}</span></td>
                        <td>{{ $location->code ?: '-' }}</td>
                        <td>{{ filled($location->type) ? str($location->type)->replace('_', ' ')->headline() : 'Other' }}</td>
                        <td>{{ $location->county ?: '-' }}</td>
                        <td>{{ $location->sub_county ?: '-' }}</td>
                        <td>{{ number_format((int) ($location->animals_count ?? 0)) }}</td>
                        <td>
