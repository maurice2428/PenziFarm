@php
    ...
    $generatedByName = $generatedBy->name ?? auth()->user()?->name ?? 'System';
    $generatedByRole = $generatedByRole ?? 'User';

    $reportTitle = $reportTitle ?? 'ERP Report';
...
<head>
    ...
    <style>
        ...
        .badge-success { background: {{ $successColor }}; }
        .badge-warning { background: {{ $accentColor }}; color: #111827; }
        .badge-danger { background: {{ $dangerColor }}; }
    ...
    <main>
        <div class="report-title">
            ...
            @if ($reportSubtitle)
                <p>{{ $reportSubtitle }}</p>
            @endif
            <p>Total records: {{ number_format($recordCount) }} • Generated {{ $eatNow->format('d M Y, H:i') }} EAT</p>
        </div>
