...
class AnimalProfile extends Page
{
    ...
    public function mount(int|string $record): void
    {
        ...
        $this->record = $this->loadProfile(
            Animal::query()->findOrFail($record)
        );
    }

    public function getTitle(): string
    {
        return strtoupper($this->record->breed?->breed_name ?? 'Animal')
            . ' Pedigree Profile — '
    ...
    {
        return $this->record->tag_number . ' Pedigree & Animal Profile';
    }
