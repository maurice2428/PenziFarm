...
class AnimalProfilePdfController extends Controller
{
    public function __invoke(Animal $animal)
    {
        ...
        $pdf = Pdf::loadView('pdf.animal-profile', [
            ...
            'qrImage' => $qrImage,
            /* Fixed two-page layout: concise most-recent operational records. */
            'healthAdministrations' => $animal->healthAdministrations->take(6),
            ...
            'treatments' => $animal->treatmentRecords->take(3),
            'treatmentCount' => $animal->treatmentRecords->count(),
            'labRequests' => $animal->labRequests->take(3),
