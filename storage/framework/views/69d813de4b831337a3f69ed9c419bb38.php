...
<script>
    ...
    function bootFarmMap() {
        const defaultLat = <?php echo \Illuminate\Support\Js::from($this->data['latitude'] ?? -0.0236)->toHtml() ?>;
        const defaultLng = <?php echo \Illuminate\Support\Js::from($this->data['longitude'] ?? 37.9062)->toHtml() ?>;
...
<?php /**PATH /home/maurice/LocalDev/Penzi/resources/views/filament/admin/components/settings-map.blade.php ENDPATH**/ ?>