...
*/
        ...
        */
        .location-card-compact {
            --location-color: <?php echo e($primaryColor); ?>;
        }
        ...
        .location-group-divider {
            ...
            background: linear-gradient(
                90deg,
                transparent,
                color-mix(in srgb, <?php echo e($primaryColor); ?> 30%, #d1d5db),
                transparent
            );
        }
        ...
        .location-group-divider::after {
            ...
            background: <?php echo e($primaryColor); ?>;
            border: 2px solid #fff;
            box-shadow: 0 0 0 1px color-mix(in srgb, <?php echo e($primaryColor); ?> 30%, #d1d5db);
        }
...
<?php unset($__componentOriginal643fe1b47aec0b76658e1a0200b34b2c); ?>
<?php endif; ?>
                                <?php echo e(number_format($totalLocationAnimals)); ?> located
                                · <?php echo e(number_format($totalGroupAnimals)); ?> grouped
                            </div>
                        </div>
...
<?php endif; ?>
                            ...
                            <div class="location-subsection-count">
                                <?php echo e(number_format($occupiedLocations)); ?> occupied
                                · <?php echo e(number_format($totalLocationAnimals)); ?> animals
                            </div>
                        </div>

                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($locationCards->isNotEmpty()): ?>
                            <div class="breed-grid-compact">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $locationCards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $location): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                    ...
                                    <a
                                        href="<?php echo e($locationUrl); ?>"
                                        class="breed-card-compact location-card-compact"
                                        style="--location-color: <?php echo e($locationColor); ?>;"
                                        title="View animals at <?php echo e($locationName); ?>"
                                    >
                                        <div class="breed-card-main">
...
<?php endif; ?>
                                            ...
                                            <div class="breed-card-info">
                                                <div
                                                    ...
                                                    title="<?php echo e($locationName); ?>"
                                                >
                                                    <?php echo e($locationName); ?>


                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if((bool) $location->is_default): ?>
                                                ...
                                                <div class="location-card-meta">
                                                    ...
                                                    <span>
                                                        <?php echo e(number_format($maleCount)); ?>

                                                        male ·
                                                        <?php echo e(number_format($femaleCount)); ?>
...
<?php endif; ?>
                                            ...
                                            <div class="breed-count-box">
                                                <div
                                                    class="breed-count-number location-count-number <?php echo e($locationCount === 0 ? 'is-zero' : ''); ?>"
                                                >
                                                    <?php echo e(number_format($locationCount)); ?>
...
<?php endif; ?>
                            ...
                            <div class="location-subsection-count">
                                <?php echo e(number_format($occupiedGroups)); ?> occupied
                                · <?php echo e(number_format($totalGroupAnimals)); ?> memberships
                            </div>
                        </div>

                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($groupCards->isNotEmpty()): ?>
                            <div class="breed-grid-compact">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $groupCards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                    ...
                                    <div
                                        ...
                                        style="--group-color: <?php echo e($groupColor); ?>;"
                                    >
                                        <div class="animal-group-main">
                                            <div class="animal-group-icon">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($group->auto_sync): ?>
                                                    <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                                            ...
                                            <div class="animal-group-info">
                                                ...
                                                <div class="animal-group-code">
                                                    <?php echo e($groupCode); ?>

                                                </div>

                                                <div
                                                    class="animal-group-scope"
                                                    title="<?php echo e($groupScope); ?>"
                                                >
                                                    <?php echo e($groupScope); ?>

                                                </div>

                                                <div
                                                    class="animal-group-type"
                                                    title="<?php echo e($groupTypeLabel); ?>"
                                                >
                                                    <?php echo e($groupTypeLabel); ?>
                                            ...
                                            <div class="animal-group-count">
                                                <div class="animal-group-count-value">
                                                    <?php echo e(number_format($groupCount)); ?>
                                        ...
                                        <div class="animal-group-footer">
                                            <div class="animal-group-actions">
                                                <a
                                                    href="<?php echo e($groupAnimalsUrl); ?>"
                                                    class="animal-group-action"
                                                    title="View animals in <?php echo e($groupName); ?>"
                                                >
                                                    <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit animal groups')): ?>
                                                    <a
                                                        href="<?php echo e($groupManageUrl); ?>"
                                                        class="animal-group-action animal-group-action-secondary"
                                                        title="Manage <?php echo e($groupName); ?>"
                                                    >
                                                        <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                ...
                <div class="farm-widget-row">
                    <?php if (isset($component)) { $__componentOriginal95d339285e17e0938b15652117dab59c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal95d339285e17e0938b15652117dab59c = $attributes; } ?>
<?php $component = App\View\Components\BreedingPerformanceDashboard::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('breeding-performance-dashboard'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\App\View\Components\BreedingPerformanceDashboard::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal95d339285e17e0938b15652117dab59c)): ?>
<?php $attributes = $__attributesOriginal95d339285e17e0938b15652117dab59c; ?>
<?php unset($__attributesOriginal95d339285e17e0938b15652117dab59c); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal95d339285e17e0938b15652117dab59c)): ?>
<?php $component = $__componentOriginal95d339285e17e0938b15652117dab59c; ?>
<?php unset($__componentOriginal95d339285e17e0938b15652117dab59c); ?>
<?php endif; ?>
                </div>
