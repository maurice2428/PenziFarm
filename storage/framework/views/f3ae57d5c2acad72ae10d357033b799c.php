<div class="geo-page" wire:key="customer-geo-intelligence-root">
    ...
    <style>
        .geo-page {
            --geo-primary: <?php echo e($primaryColor); ?>;
            --geo-secondary: <?php echo e($secondaryColor); ?>;
            --geo-accent: <?php echo e($accentColor); ?>;
...
<?php endif; ?>
            ...
            <div class="geo-hero-mini-grid">
                <div class="geo-hero-mini">
                    ...
                    <div class="geo-hero-mini-value"><?php echo e($mapCoverage); ?>%</div>
                </div>

                <div class="geo-hero-mini">
                    <div class="geo-hero-mini-label">Unmapped Customers</div>
                    <div class="geo-hero-mini-value"><?php echo e(number_format($unmappedCustomers)); ?></div>
                </div>

                <div class="geo-hero-mini">
                    <div class="geo-hero-mini-label">Avg Animals / Customer</div>
                    <div class="geo-hero-mini-value"><?php echo e($averageAnimalsPerCustomer); ?></div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="geo-filter-grid">
            ...
            <div>
                ...
                <select class="geo-select" wire:model.live="country">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div>
                ...
                <div class="geo-check">
                    <?php echo e(number_format(count($points))); ?> customer location(s)
                </div>
            </div>
        </div>
    </div>
...
<?php endif; ?>
            ...
            <div class="geo-card-value"><?php echo e(number_format($totalCustomers)); ?></div>
            <div class="geo-card-foot"><?php echo e(number_format($mappedCustomerDatabaseCount)); ?> customer profiles have coordinates.</div>
        </div>
...
<?php endif; ?>
            ...
            <div class="geo-card-value"><?php echo e(number_format($totalAnimals)); ?></div>
            <div class="geo-card-foot">Average <?php echo e($averageAnimalsPerCustomer); ?> animal(s) per mapped buyer.</div>
        </div>
...
<?php endif; ?>
            ...
            <div class="geo-card-value"><?php echo e(number_format($totalInvoices)); ?></div>
            <div class="geo-card-foot">Filtered between <?php echo e($fromDate); ?> and <?php echo e($toDate); ?>.</div>
        </div>
...
<?php endif; ?>
            ...
            <div class="geo-card-value"><?php echo e($totalRevenueFormatted); ?></div>
            <div class="geo-card-foot">Avg <?php echo e($averageRevenuePerCustomerFormatted); ?> per mapped customer.</div>
        </div>
    </div>
    ...
    <div class="geo-insight-grid">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $insights; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $insight): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="geo-insight-card">
                <div class="geo-insight-title"><?php echo e($insight['title']); ?></div>
                <div class="geo-insight-value"><?php echo e($insight['value']); ?></div>
                <div class="geo-insight-body"><?php echo e($insight['body']); ?></div>
            </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    </div>
    ...
    <div class="geo-layout">
        ...
        <div class="geo-side">
            <div class="geo-panel" style="margin-top: 0;">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $topLocations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $location): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="geo-location-row">
                        <div>
                            <div class="geo-location-name"><?php echo e($location['location']); ?></div>
                            <div class="geo-location-meta">
                                <?php echo e(number_format($location['customers'])); ?> customer(s) ·
                                <?php echo e(number_format($location['animals'])); ?> animal(s) ·
                                <?php echo e($location['revenue_formatted']); ?>

                            </div>
                        </div>

                        <div class="geo-pill">
                            <?php echo e(number_format($location['animals'])); ?>
            ...
            <div class="geo-panel" style="margin-top: 0;">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $topCountries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="geo-location-row">
                        <div>
                            <div class="geo-location-name"><?php echo e($country['country']); ?></div>
                            <div class="geo-location-meta">
                                <?php echo e(number_format($country['customers'])); ?> customer(s) ·
                                <?php echo e(number_format($country['animals'])); ?> animal(s) ·
                                <?php echo e($country['revenue_formatted']); ?>

                            </div>
                        </div>

                        <div class="geo-pill">
                            <?php echo e(number_format($country['animals'])); ?>
            ...
            <div class="geo-panel" style="margin-top: 0;">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $topCustomers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="geo-location-row">
                        <div>
                            <div class="geo-location-name"><?php echo e($customer['customer']); ?></div>
                            <div class="geo-location-meta">
                                <?php echo e($customer['location']); ?> ·
                                <?php echo e(number_format($customer['animals'])); ?> animal(s) ·
                                <?php echo e($customer['revenue_formatted']); ?>

                            </div>
                        </div>

                        <div class="geo-pill">
                            <?php echo e(number_format($customer['invoices'])); ?> inv.
                        </div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <div class="mt-3 text-sm text-gray-500 dark:text-gray-300">
            ...
            <div class="geo-panel" style="margin-top: 0;">
                ...
                <div class="geo-section-subtitle">
                    <?php echo e(number_format($unmappedCustomers)); ?> customer(s) are not appearing because they do not have latitude and longitude.
    ...
    <script>
        (function () {
            const initialPoints = <?php echo json_encode($points, 15, 512) ?>;
            const primaryColor = <?php echo json_encode($primaryColor, 15, 512) ?>;
            const accentColor = <?php echo json_encode($accentColor, 15, 512) ?>;
...
<?php /**PATH /home/maurice/LocalDev/Penzi/resources/views/filament/pages/sales/customer-geo-intelligence.blade.php ENDPATH**/ ?>